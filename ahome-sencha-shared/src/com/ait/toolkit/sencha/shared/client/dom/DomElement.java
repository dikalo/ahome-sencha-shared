...
import com.ait.toolkit.sencha.shared.client.core.Direction;
import com.ait.toolkit.sencha.shared.client.core.config.AnimationConfig;
import com.ait.toolkit.sencha.shared.client.core.config.BaseConfig;
import com.ait.toolkit.sencha.shared.client.core.config.ListenerConfig;
import com.ait.toolkit.sencha.shared.client.core.handlers.EventCallback;
...
import com.ait.toolkit.sencha.shared.client.fx.FxConfig;
import com.ait.toolkit.sencha.shared.client.util.KeyMap;
import com.ait.toolkit.sencha.shared.client.util.KeyMapConfig;
...
public class DomElement extends JsObject implements Fx {
	...
	public native DomElement addCls(String... classNames)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		elem
				.addCls(@com.ait.toolkit.core.client.JsoHelper::convertToJavaScriptArray([Ljava/lang/Object;)(classNames));
		return this;
	}-*/;
	...
	public native KeyMap addKeyListener(int keyCode, KeyListener listener)/*-{
		...
		return @com.ait.toolkit.sencha.shared.client.util.KeyMap::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(km);
	}-*/;
	...
	public native KeyMap addKeyListener(int[] keyCodes, KeyListener listener)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var keyCodesJS = @com.ait.toolkit.core.client.JsoHelper::convertToJavaScriptArray([I)(keyCodes);
		var km = elem
				.addKeyListener(
						keyCodesJS,
						function(key, event) {
		...
		el
				.addListener(
						...
						function(event) {
							...
							cb.@com.ait.toolkit.sencha.shared.client.core.handlers.EventCallback::execute(Lcom/ait/toolkit/sencha/shared/client/core/EventObject;)(e);
						});
	}-*/;
	...
	public native void addListener(String eventName, EventCallback cb,
		...
		el
				.addListener(
						...
						function(event) {
							var e = (event === undefined || event == null) ? null
									: @com.ait.toolkit.sencha.shared.client.core.EventObject::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							cb.@com.ait.toolkit.sencha.shared.client.core.handlers.EventCallback::execute(Lcom/ait/toolkit/sencha/shared/client/core/EventObject;)(e);
						},
						null,
						config.@com.ait.toolkit.sencha.shared.client.core.config.ListenerConfig::getJsObj()());
	}-*/;
	 ...
	 * @return this
	 */
	public native DomElement alignTo(String id, String anchorPosition,
			int[] offsetXY, boolean animate)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var offsetJS = @com.ait.toolkit.core.client.JsoHelper::convertToJavaScriptArray([I)(offsetXY);
	 ...
	 */
	public native DomElement anchorTo(String id, String anchorPosition,
			int[] offsetXY, boolean animate, int bufferDelay)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var offsetJS = @com.ait.toolkit.core.client.JsoHelper::convertToJavaScriptArray([I)(offsetXY);
	...
	public native DomElement animate(BaseConfig args)/*-{
		...
		var argsJS = args == null ? null
				: args.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		elem.animate(argsJS);
		return this;
	}-*/;
	 ...
	 * @return this
	 */
	public native DomElement animate(BaseConfig args, float duration,
			Function onComplete, Easing easing, String animType)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var argsJS = args == null ? null
				: args.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var easingJS = easing.@com.ait.toolkit.sencha.shared.client.fx.Easing::getValue()();
		elem.animate(argsJS, duration, onComplete == null ? null : function() {
			onComplete.@com.ait.toolkit.core.client.Function::execute()();
		}, easingJS, animType);
		return this;
	}-*/;
	 ...
	 * @return this
	 */
	public native DomElement autoHeight(boolean animate, float duration,
			Function onComplete, Easing easing)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var easingJS = easing.@com.ait.toolkit.sencha.shared.client.fx.Easing::getValue()();
	...
	public native DomElement hide(AnimationConfig animateConfig)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var animateConfigJS = animateConfig.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	...
	public native DomElement move(Direction direction, int distance)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var directionJS = direction.@com.ait.toolkit.sencha.shared.client.core.Direction::getDirection()();
	...
	public native DomElement radioCls(String[] classNames)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var classNamesJS = @com.ait.toolkit.core.client.JsoHelper::convertToJavaScriptArray([Ljava/lang/Object;)(classNames);
	 ...
	 */
	public native boolean scroll(Direction direction, int distance,
			boolean animate)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var directionJS = direction.@com.ait.toolkit.sencha.shared.client.core.Direction::getDirection()();
	 ...
	 * @return this
	 */
	public native DomElement scrollTo(String side, int value,
			AnimationConfig animateConfig)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var animateConfigJS = animateConfig.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	 ...
	 * @return this
	 */
	public native DomElement setBox(Box box, boolean adjust,
			AnimationConfig animateConfig)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var boxJS = box.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var animateConfigJS = animateConfig.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	 ...
	 * @return this
	 */
	public native DomElement setLocation(int x, int y,
			AnimationConfig animateConfig)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var animateConfigJS = animateConfig.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	 ...
	 * @return this
	 */
	public native DomElement setOpacity(float opacity,
			AnimationConfig animateConfig)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var animateConfigJS = animateConfig.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	...
	public native DomElement setRegion(Region region, boolean animate)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var regionJS = region.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	 ...
	 * @return this
	 */
	public native DomElement setRegion(Region region,
			AnimationConfig animateConfig)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var regionJS = region.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var animateConfigJS = animateConfig.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	 ...
	 * @return this
	 */
	public native DomElement setSize(int width, int height,
			AnimationConfig animateConfig)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var animateConfigJS = animateConfig.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	...
	public native DomElement setStyles(BaseConfig styles)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var stylesJS = styles.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	 ...
	 * @return this
	 */
	public native DomElement setVisible(boolean visible,
			AnimationConfig animateConfig)/*-{
		var elem = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var animateConfigJS = animateConfig.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	...
	public native Fx highlight(String color, String attr, String endColor,
			FxConfig config) /*-{
		var el = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var configJS = config.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		if (attr != null) {
	...
	public native Fx slideOut(boolean remove, String anchorPosition,
			FxConfig config) /*-{
		var el = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var configJS = config.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		configJS['remove'] = remove;
