...
public class Paddings {
	...
	private static Paddings instance(JavaScriptObject jsObj) {
		return new Paddings(JsoHelper.getIntArrayValue(jsObj, 0),
				JsoHelper.getIntArrayValue(jsObj, 1),
				JsoHelper.getIntArrayValue(jsObj, 2),
				JsoHelper.getIntArrayValue(jsObj, 3));
	}
	...
	public String getStyleString() {
		return "padding:" + top + "px " + right + "px " + bottom + "px " + left
				+ "px;";
	}
}