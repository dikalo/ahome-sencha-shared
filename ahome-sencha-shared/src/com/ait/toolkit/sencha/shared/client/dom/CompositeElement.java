...
public class CompositeElement extends JsObject {
	...
	public native CompositeElement add(String selector) /*-{
		var ce = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		ce.add(selector);
		return this;
	}-*/;
	...
	public native void contains(ExtElement element) /*-{
		var ce = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var elJS = element.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	 ...
	 * @return this
	 */
	public native CompositeElement replaceElement(int index,
			ExtElement replacement) /*-{
		var ce = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var replacementJS = replacement.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	 ...
	 */
	public native CompositeElement replaceElement(int index,
			ExtElement replacement, boolean removeDom) /*-{
		var ce = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var replacementJS = replacement.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	 ...
	 * @return this
	 */
	public native CompositeElement replaceElement(ExtElement element,
			ExtElement replacement) /*-{
		var ce = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var elJS = element.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var replacementJS = replacement.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	...
	public native ExtElement item(int index)/*-{
		...
		return obj ? @com.ait.toolkit.sencha.shared.client.dom.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj)
				: null;
	}-*/;
}
