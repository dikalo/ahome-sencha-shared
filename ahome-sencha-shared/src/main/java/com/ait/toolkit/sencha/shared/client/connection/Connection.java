...
public class Connection extends JsObject {
	...
	public Connection(ConnectionConfig config) {
		jsObj = _create(config.getJsObj());
	}

	private native JavaScriptObject _create(JavaScriptObject config) /*-{
	...
	public native void abort() /*-{
		var conn = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		conn.abort();
	}-*/;
	...
	public native double request(RequestParam param) /*-{
		var conn = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var paramJS = param.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	...
	public native void addListener(ConnectionListener listener)/*-{
		...
		conn
				.addListener(
						...
						function(conn, options) {
							return listener.@com.ait.toolkit.sencha.shared.client.connection.ConnectionListener::doBeforeRequest(Lcom/ait/toolkit/sencha/shared/client/connection/Connection;)(conJ);
						});
		...
		conn
				.addListener(
						...
						function(conn, response, options) {
							return listener.@com.ait.toolkit.sencha.shared.client.connection.ConnectionListener::onRequestComplete(Lcom/ait/toolkit/sencha/shared/client/connection/Connection;Ljava/lang/String;)(connJ, response.responseText);
						});
		...
		conn
				.addListener(
						'requestexception',
						function(conn, response, options) {
							return listener.@com.ait.toolkit.sencha.shared.client.connection.ConnectionListener::onRequestComplete(Lcom/ait/toolkit/sencha/shared/client/connection/Connection;Ljava/lang/String;)(connJ, response.status, response.responseText);
						});
	}-*/;
}
