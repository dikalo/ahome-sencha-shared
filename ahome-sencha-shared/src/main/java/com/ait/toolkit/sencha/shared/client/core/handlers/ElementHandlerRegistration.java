...
public class ElementHandlerRegistration implements
	...
	public native void unregister()/*-{
		var widget = this.@com.ait.toolkit.sencha.shared.client.core.handlers.ElementHandlerRegistration::getElement()();
		var widgetPeer = widget.@com.ait.toolkit.sencha.shared.client.dom.ExtElement::getJsObj()();
		var event = this.@com.ait.toolkit.sencha.shared.client.core.handlers.ElementHandlerRegistration::getEventName()();
		var fn = this.@com.ait.toolkit.sencha.shared.client.core.handlers.ElementHandlerRegistration::getCallback()();
