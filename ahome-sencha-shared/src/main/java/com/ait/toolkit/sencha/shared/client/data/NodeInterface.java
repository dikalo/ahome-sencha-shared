...
import com.ait.toolkit.sencha.shared.client.data.handlers.BubbleHandler;
		...
		if (jso) {
			jso
					.bubble($entry(function(node) {
						...
						handler.@com.ait.toolkit.sencha.shared.client.data.handlers.BubbleHandler::onNodeTraverse(Lcom/ait/toolkit/sencha/shared/client/data/NodeInterface;)(nodeObject);
					}));
		}
