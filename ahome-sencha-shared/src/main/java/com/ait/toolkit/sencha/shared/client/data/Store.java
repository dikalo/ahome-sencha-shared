...
import com.ait.toolkit.sencha.shared.client.data.handlers.BeforeLoadHandler;
import com.ait.toolkit.sencha.shared.client.data.handlers.BeforePrefetchHandler;
import com.ait.toolkit.sencha.shared.client.data.handlers.ClearHandler;
import com.ait.toolkit.sencha.shared.client.data.handlers.DataAddedHandler;
import com.ait.toolkit.sencha.shared.client.data.handlers.DataChangedHandler;
import com.ait.toolkit.sencha.shared.client.data.handlers.EachCallBack;
import com.ait.toolkit.sencha.shared.client.data.handlers.GroupingHandler;
import com.ait.toolkit.sencha.shared.client.data.handlers.LoadCallback;
import com.ait.toolkit.sencha.shared.client.data.handlers.RemoveHandler;
import com.ait.toolkit.sencha.shared.client.data.handlers.UpdateHandler;
import com.ait.toolkit.sencha.shared.client.data.proxy.ProxyConfig;
import com.ait.toolkit.sencha.shared.client.util.Direction;
import com.ait.toolkit.sencha.shared.client.util.FilterConfig;
import com.ait.toolkit.sencha.shared.client.util.FilterFunction;
import com.ait.toolkit.sencha.shared.client.util.Grouper;
import com.ait.toolkit.sencha.shared.client.util.GrouperConfig;
...
public class Store extends JsObject {
    ...
    protected final static String model = "ahome-ext-model-";
    ...
    public Store( String... fields ) {
        this( new ArrayList<BaseModel>(), fields );
    }
    ...
    public native void addGrouper( Grouper grouper )/*-{
		var jso = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		jso.groupers
				.add(grouper.@com.ait.toolkit.core.client.JsObject::getJsObj()());
    }-*/;
     ...
     * @return
     */
    public native <T extends BaseModel> T findBaseModel( String fieldName, String value, int startIndex, boolean anyMatch,
    ...
    public native void each( EachCallBack callback )/*-{
		...
		jso
				.each(function(record) {
					...
					callback.@com.ait.toolkit.sencha.shared.client.data.handlers.EachCallBack::onEach(Lcom/ait/toolkit/data/client/BaseModel;)(model);
				});
    }-*/;
    ...
    public native String addGroupingHandler( GroupingHandler handler )/*-{
		...
		jso.getGroupString = function(record) {
			var model = @com.ait.toolkit.data.client.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(record);
			return handler.@com.ait.toolkit.sencha.shared.client.data.handlers.GroupingHandler::forEach(Lcom/ait/toolkit/data/client/BaseModel;)(model);
		};
    }-*/;
    ...
    public native void sync()/*-{
		var store = store.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		store.sync();
    }-*/;

    public static native void commitChanges()/*-{
		var store = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		store.commitChanges();
    }-*/;
    ...
    public native void load( LoadCallback handler )/*-{
		...
		jso
				.load($entry(function(recs, op, success) {
					var data = @com.ait.toolkit.data.client.BaseModel::fromJsArray(Lcom/google/gwt/core/client/JavaScriptObject;)(recs);
					var operation = @com.ait.toolkit.sencha.shared.client.data.Operation::new(Lcom/google/gwt/core/client/JavaScriptObject;)(op);
					handler.@com.ait.toolkit.sencha.shared.client.data.handlers.LoadCallback::onLoad(Ljava/util/List;Lcom/ait/toolkit/sencha/shared/client/data/Operation;Z)(data,operation,success);
				}));
    }-*/;
    ...
    public native void addDataAddedHandler( DataAddedHandler handler )/*-{
		...
		jso
				.addListener(
						"add",
						function(store, data) {
							var s = @com.ait.toolkit.sencha.shared.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.ait.toolkit.sencha.shared.client.data.handlers.DataAddedHandler::onAdd(Lcom/ait/toolkit/sencha/shared/client/data/Store;Lcom/google/gwt/core/client/JavaScriptObject;)(s, data);
						});
    }-*/;
    ...
    public native void addBeforeLoadHandler( BeforeLoadHandler handler )/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.ait.toolkit.sencha.shared.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.ait.toolkit.sencha.shared.client.data.handlers.BeforeLoadHandler::onBeforeLoad(Lcom/ait/toolkit/sencha/shared/client/data/Store;)(s);
						});
    }-*/;
    ...
    public native void addBeforePrefetch( BeforePrefetchHandler handler )/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.ait.toolkit.sencha.shared.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.ait.toolkit.sencha.shared.client.data.handlers.BeforePrefetchHandler::onBeforePrefetch(Lcom/ait/toolkit/sencha/shared/client/data/Store;)(s);
						});
    }-*/;
    ...
    public native void addClearHandler( ClearHandler handler )/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.ait.toolkit.sencha.shared.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.ait.toolkit.sencha.shared.client.data.handlers.ClearHandler::onClear(Lcom/ait/toolkit/sencha/shared/client/data/Store;)(s);
						});
    }-*/;
    ...
    public native void addDataChangedHandler( DataChangedHandler handler )/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.ait.toolkit.sencha.shared.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.ait.toolkit.sencha.shared.client.data.handlers.DataChangedHandler::onDataChanged(Lcom/ait/toolkit/sencha/shared/client/data/Store;)(s);
						});
    }-*/;
    ...
    public native void addRemoveHandler( RemoveHandler handler )/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.ait.toolkit.sencha.shared.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.ait.toolkit.sencha.shared.client.data.handlers.RemoveHandler::onRemove(Lcom/ait/toolkit/sencha/shared/client/data/Store;)(s);
						});
    }-*/;
    ...
    public native void addUpdateHandler( UpdateHandler handler )/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.ait.toolkit.sencha.shared.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.ait.toolkit.sencha.shared.client.data.handlers.UpdateHandler::onUpdate(Lcom/ait/toolkit/sencha/shared/client/data/Store;)(s);
						});
    }-*/;
