...
public class DateUtil {
	...
	public static native String format(Date date, String format) /*-{
																	...
																	var millis = @com.ait.toolkit.sencha.shared.client.util.DateUtil::getTime(Ljava/util/Date;)(date);
	...
	public static native Date parse(String input, String format)/*-{
																...
																return @com.ait.toolkit.sencha.shared.client.util.DateUtil::create(D)(date.getTime());
																}-*/;
	...
	public static native Date add(Date date, Interval interval, int value)/*-{
																			var intervalJS = interval.@com.ait.toolkit.sencha.shared.client.util.DateUtil.Interval::getInterval()();
																			var millis = @com.ait.toolkit.sencha.shared.client.util.DateUtil::getTime(Ljava/util/Date;)(date);
																			var dateJS = new $wnd.Date(millis);
																			var newDate = $wnd.Ext.Date.add(dateJs,intervalJS, value);
																			return  @com.ait.toolkit.sencha.shared.client.util.DateUtil::create(D)(newDate.getTime());
																			}-*/;
	...
	public static native Date clearTime(Date date)/*-{
													var millis = @com.ait.toolkit.sencha.shared.client.util.DateUtil::getTime(Ljava/util/Date;)(date);
													var dateJS = new $wnd.Date(millis);
													var newDate = $wnd.Ext.Date.clearTime(dateJs);
													return @com.ait.toolkit.sencha.shared.client.util.DateUtil::create(D)(newDate.getTime());
													}-*/;
